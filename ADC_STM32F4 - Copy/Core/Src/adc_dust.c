...
//         ; // Chờ đến khi bộ đếm đạt giá trị delay
// }
...
//     // Bật LED (Power on)
//     HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_SET);      // LOW: LED bật
...
//     // Tắt LED
//     HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_RESET); // HIGH: LED tắt
